package com.example.eventstorecommand.domain.model;

import com.example.eventstorecommand.domain.event.BoardInitialized;
import com.example.eventstorecommand.domain.event.BoardRenamed;
import com.example.eventstorecommand.domain.event.DomainEvent;
import com.example.eventstorecommand.domain.event.StoryAdded;
import com.example.eventstorecommand.domain.event.StoryDeleted;
import com.example.eventstorecommand.domain.event.StoryUpdated;
